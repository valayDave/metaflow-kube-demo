from metaflow import FlowSpec, step, Parameter, IncludeFile, batch, retry,conda_base,environment,kube
import struct
...
class GPUMINSTTensorFlow(FlowSpec):
    ...
    @kube(cpu=3,memory=8000,image='tensorflow/tensorflow:1.9.0-gpu-py3',gpu=1)
    @step
